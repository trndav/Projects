...
#             # Both bubbles lose population based on attack rates
...
#         # Check if a neutral bubble is defeated
...
#         """Neutral bubble becomes owned by the attacking bubble."""
#         self.is_neutral = False
#         self.color = owner_bubble.color  # Change color to that of the attacker
#         self.population = 10  # Reset the population to a base amount
#         self.grow_button = pygame.Rect(self.x - 60, self.y + 50, 60, 30)
#         self.attack_button = pygame.Rect(self.x + 5, self.y + 50, 60, 30)

#         # Remove the connection to this bubble from the connections list
#         connections_to_remove = []
#         for conn in connections:
#             if self in conn:  # Check if this bubble is part of a connection
...
#     def grow(self):
#         # Only allow growing if the bubble has more than 10 population
#         if not self.is_neutral and self.population > 12:
#             self.growth_rate = GROWTH_RATE
#             self.population -= 10  # Reduce population by 10
